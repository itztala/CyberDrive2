        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              ...
              you're a student, an enthusiast, or just curious — defend the virtual car, close the vulnerable ports, and
              challenge yourself to stop cyber attacks before they strike.
            </p>
